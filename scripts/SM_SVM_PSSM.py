def TopoPRED(w_size, x_value):
    ...
    printfile=open('../output/SM_SVM_ws_' + str(w_size) + '_x-fold-validation_' + str(x_value) + '.txt', 'w')
    ...
    plt.savefig('../output/SM_SVM_ws_' + str(w_size) + 'fold_validation_' + str(x_value) + '.png')

def TopoPRED(w_size, x_value):
    ...
    printfile=open('../output/SM_DT_PSSM_balanced_ws_' + str(w_size) + '_x-fold-validation_' + str(x_value) + '.txt', 'w')
    ...
    plt.title('SM_DT_PSSM_ws: ' + str(w_size) + ' fold-validation: ' + str(x_value) + ' F1: ' + str(f1_score))
    plt.colorbar()
    ...
    plt.savefig('../output/SM_DT_PSSM_balanced_ws_' + str(w_size) + 'fold_validation_' + str(x_value) + '.png')
